({
              ...
              TABLE(
                ...
                TBODY(
                  ...
                  TR(
                    ...
                    TD(
                      {},
                      SPAN({ class: 'badge bg-label-primary rounded-pill text-uppercase' }, SPAN({ text: 'Zipcar' })),
                    ),
                  ...
                  TR(
                    ...
                    TD(
                      {},
                      SPAN({ class: 'badge bg-label-danger rounded-pill text-uppercase' }, SPAN({ text: 'Bitbank' })),
                    ),
                  ...
                  TR(
                    ...
                    TD(
                      {},
                      SPAN({ class: 'badge bg-label-warning rounded-pill text-uppercase' }, SPAN({ text: 'Payers' })),
                    ),
                  ...
                  TR(
                    ...
                    TD(
                      {},
                      SPAN({ class: 'badge bg-label-info rounded-pill text-uppercase' }, SPAN({ text: 'Brandi' })),
                    ),
  ...
  on: {
    load: (el) => {
      window.loadRes('/theme/sneat/apexcharts.js');
      window.runAfterResLoaded('/theme/sneat/apexcharts.js', () => {
        window.loadRes('theme/sneat/dashboards-crm.js');
      });
    },
    itemLoad: () => {},
  },
