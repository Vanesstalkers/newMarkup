            ...
            DIV(
              ...
              DIV(
                ...
                DIV(
                  ...
                  // H4({ class: 'mb-2' }, SPAN({ text: 'Violet Mendoza' })),
                  ...
                  // SPAN({ class: 'badge bg-label-secondary' }, SPAN({ text: 'Author' })),
                ),
              ),
            ),
            DIV(
        ...
        DIV(
          ...
          DIV(
            ...
            DIV(
              ...
              SPAN({ class: 'badge bg-label-primary' }, SPAN({ text: 'Standard' })),
              DIV(
                { class: 'd-flex justify-content-center' },
                SUP({ class: 'h5 pricing-currency mt-3 mb-0 me-1 text-primary' }, SPAN({ text: '$' })),
                H1({ class: 'display-5 mb-0 text-primary' }, SPAN({ text: '99' })),
                SUB({ class: 'fs-6 pricing-duration mt-auto mb-3' }, SPAN({ text: '/month' })),
              ),
            ),
            UL(
              { class: 'ps-3 g-2 my-4' },
              LI({ class: 'mb-2' }, SPAN({ text: '10 Users' })),
              LI({ class: 'mb-2' }, SPAN({ text: 'Up to 10 GB storage' })),
              LI({}, SPAN({ text: 'Basic Support' })),
            ),
            DIV(
              { class: 'd-flex justify-content-between align-items-center mb-1' },
              SPAN({}, SPAN({ text: 'Days' })),
              SPAN({}, SPAN({ text: '65% Completed' })),
            ),
            DIV(
            ...
            SPAN({}, SPAN({ text: '4 days remaining' })),
            DIV(
              { class: 'd-grid w-100 mt-4 pt-2' },
              BUTTON(
                { class: 'btn btn-primary', 'data-bs-target': '#upgradePlanModal', 'data-bs-toggle': 'modal' },
